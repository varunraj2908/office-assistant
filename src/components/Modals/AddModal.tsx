...
const AddModal = ({
  ...
  return (
    <div
      className={`w-screen h-screen place-items-center fixed z-30 top-0 left-0 ${
        isOpen ? "grid" : "hidden"
      }`}
    >
      <div
      ...
      ></div>
      <div
        className="md:w-[40vw] w-[100%]  bg-gradient-to-tr from-slate-300/30 via-gray-400/30 to-slate-600/30 backdrop-blur-md shadow-md z-50 rounded-xl overflow-hidden"
        style={{
